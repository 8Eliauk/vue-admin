  ...
  <div>
    ...
    <el-table style="width: 100%" border :data="records">
      ...
      <el-table-column
        ...
        width="width"
      ></el-table-column>
      <el-table-column label="默认图片" width="110px" align="center">
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="16"> 
          <template>
            <el-tag type="success" v-for="(attr,index) in skuInfo.skuAttrValueList" :key="attr.id" style="margin-right:10px">
